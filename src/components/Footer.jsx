...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/suhanitomar888',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/suhanitomar/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:suhanitomar888@gmail.com',
      icon: (
    ...
    <footer className="border-t border-[color:var(--line)] bg-[color:var(--surface)]/90 backdrop-blur-xl">
      <div className="mx-auto w-[min(1120px,92vw)] py-12">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          <div className="space-y-4">
            ...
            <p className="text-sm text-[color:var(--muted)]">
              ...
              and building impactful analytical solutions.
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-[color:var(--line)] pt-8 text-center">
          <p className="text-sm text-[color:var(--muted)]">
            © {currentYear} Suhani Tomar. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
